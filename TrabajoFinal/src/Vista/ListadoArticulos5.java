...
public class ListadoArticulos5 extends javax.swing.JInternalFrame {

    Conexion enlace = new Conexion();
    java.sql.Connection conect = enlace.conectar();
    
    
    public ListadoArticulos5() {
        initComponents();
...
//
//                Compra.txtCodProducto.setText(String.valueOf(id));
//                Compra.txtProducto.setText(nombre);
//                Compra.txtPrecio.setText(String.valueOf(precio));
//                Compra.txtStock.setText(String.valueOf(stock));
//                
//                dispose();
//            }
//            catch(Exception e)
...
//        }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        RegistrarArticulo lrs= new RegistrarArticulo();
