...
public class ListadoFormaPago5 extends javax.swing.JInternalFrame {

    Conexion enlace = new Conexion();
    java.sql.Connection conect = enlace.conectar();
    
    public ListadoFormaPago5() {
        initComponents();
...
//                Compra.txtPago.setText(String.valueOf(id));
//                Compra.txtMedioPago.setText(forma_pago);
